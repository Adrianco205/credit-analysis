...
CREATE TABLE IF NOT EXISTS bancos (
    ...
    codigo_superintendencia varchar(10),
    nit varchar(20),
    patron_identificacion text,
    soporta_uvr boolean DEFAULT true,
    soporta_frech boolean DEFAULT true,
...
CREATE TABLE IF NOT EXISTS usuarios (
    ...
    ciudad_departamento varchar(200),
