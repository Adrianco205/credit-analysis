    ...
    return (
        <div className="max-w-3xl mx-auto py-8 space-y-6">
            ...
            <div className="flex items-center justify-between">
                ...
                <h1 className="text-2xl font-bold text-[var(--verde-bosque)]">
            ...
            <Card className="border-t-4 border-green-500">
                <div className="text-center py-6 space-y-3">
                    ...
                    <p className="text-gray-600 max-w-md mx-auto">
                        Resumen de tu crédito hipotecario.
                    </p>
                </div>
            </Card>
            ...
            {summaryData && (
                <div className="space-y-4">
                    ...
                    <div className="flex flex-wrap gap-4 text-xs text-gray-500 bg-gray-50 p-3 rounded-lg">
                        ...
                        {summaryData.banco_nombre && <span><strong>Banco:</strong> {summaryData.banco_nombre}</span>}
                    </div>
                </div>
            )}
